...
for (si in SUBCLASS_INFO) {
	...
	specimen_ids <- h5read(h5_cv_filename, "specimen_ids/ephys/train")
	test_specimen_ids <- h5read(h5_cv_filename, "specimen_ids/ephys/test")
...
#         inf_met_type_df$inferred_met_type %in% set_of_types]
    ...
    save_to_h5(ephys_relaxed_result, genes, sample_spec_ids$spec_id_label, test_specimen_ids,
