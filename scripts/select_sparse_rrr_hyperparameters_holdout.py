...
def main(args):
    ...
    for si in SUBCLASS_INFO:
        ...
        f = h5py.File(os.path.join(input_dir, f"sparse_rrr_cv_holdout_{filepart}.h5"), "r")
        tx_pc_f = h5py.File(os.path.join(input_dir, f"tx_pc_elasticnet_cv_holdout_{filepart}.h5"), "r")
